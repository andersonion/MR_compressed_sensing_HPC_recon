...
if isempty(MATLAB_EXEC_PATH)
    ...
    error('Missing required env var ''MATLAB_EXEC_PATH''');
elseif ~exist(MATLAB_EXEC_PATH,'dir')
    error('Missing directory from env var ''MATLAB_EXEC_PATH'', no %s',MATLAB_EXEC_PATH);
end
