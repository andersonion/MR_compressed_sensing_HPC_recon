...
addpath([getenv('WKS_SHARED') '/civm_matlab_common_utils/mrsolutions']);
addpath([getenv('WKS_SHARED') '/civm_matlab_common_utils/agilent']);
addpath([getenv('WKS_SHARED') '/civm_matlab_common_utils/classy']);
